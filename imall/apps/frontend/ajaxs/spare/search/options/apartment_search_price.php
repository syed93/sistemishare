...
<table class="tableCenter">
 ...
 <td><select name="pf" style="width: 120px;" id="ps_3" >
				...
				</select></td>	<td><select name="ros" style="width: 120px;" id="rooms_ros" >
 ...
 <td><select name="pt" style="width: 120px;" id="pe" >
			...
			</td>	<td><select name="roe" style="width: 120px;" id="rooms_roe" >
						<option value=""  selected="selected">Max bedrooms</option>
							<option value="1" >1</option>
							<option value="2" >2</option>
							<option value="3" >3</option>
							<option value="4" >4</option>
					...
					</select></td><td><select name="se" style="width: 120px;" id="se_2" >
