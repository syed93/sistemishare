...
<tr>
	<td></td>
	<td><select name="carMileage" id="ValidSelectionCarMileage">
	...
	<td></td>
	<td><select name="carColor" id="ValidSelectionCarColor">
	                             <option value="">-Color-</option>
                                <option value="Metallic">Metallic</option>
                                <option value="Solid">Solid</option>
                                <option value="Others">Others</option>
     </select>  </td>
     <td><select name="carYear" id="ValidSelectionCarYear">
...
Price: <input type="text" name="priceDefault"> / <select name="priceRent" id="ValidSelectionCarColor">
