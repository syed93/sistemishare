...
<div class="line">
  <div class="jun_view">
      <h4>iManagement done renew with iShare</h4>
      ...
      <div class="imanagement_menu">
	      ...
	      {{ link_to("insuran/done", "Done", "class": "jun_button jun_button_current") }}
      </div>
      ...
      <form action="" method="GET">
		...
		<tr>
			...
			<td><p>{{post.year}}</p></td>
			<td><p>{{ link_to("insuran/update/" ~ post.username, "Update", "class": "jun_button") }}</p></td>
		</tr>
		{% endfor %}
		</table>
