...
<div class="line">
  <div class="jun_view">
      <h4>iManagement KIV</h4>
      
      <div class="line"></div>
      <div class="imanagement_menu">
      {{ link_to("insuran/manage", "iManagement", "class": "jun_button") }}
      {{ link_to("insuran/quotation", "Updated", "class": "jun_button") }}
      {{ link_to("insuran/kiv", "Problems", "class": "jun_button jun_button_current") }}
      ...
      <form action="" method="GET">
		...
		<tr>
			...
			{{ link_to("insuran/renew/" ~ post.username, "Renew", "class": "jun_button") }}&nbsp;
			{{ link_to("insuran/kiv?ref=b5x4tAV2BdzsMEKb2ZQMgY46cavQC0qXhZJoB4zdnJZIH6UCyk8DyP8bIaLAfxB&user_id=" ~ post.id, "Restore", "class": "jun_button") }}</p></td>
		</tr>
		{% endfor %}
		</table>
