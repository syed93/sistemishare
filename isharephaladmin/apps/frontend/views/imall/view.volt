...
<div class="jun_right line"> 
		...
		<div class="big_box jun_label">	 
			...
			<div class="jun_text_on_form">
				...
				{% if post.image != '' %}
				    <div id="jun_images"><img src="{{image_dir}}{{post.image}}" alt="{{post.title}}" title="post.title"></div>
				{% endif %}
				...
				<tr><td>
				<div class="jun_post_approval">
				    <form action="" method="post">
				    <select name="reason">
				        <option value="0">If reject, choose reason</option>
				        <option value="Copyright Violation">Copyright Violation</option>
				        <option value="Misleading">Misleading</option>
				        <option value="Illegal Goods">Illegal goods</option>
				        <option value="Offensive content">Offensive content</option>
				        <option value="Pirated goods and forgeries">Pirated goods and forgeries</option>
				        <option value="Image too small">Image too small</option>
				        <option value="Image contain Watermark">Image contain Watermark</option>
				        <option value="Image not clear">Image not clear</option>
				        <option value="Not suitable image">Not suitable image</option>
				        <option value="Image is not JPEG format">Image is not JPEG format</option>
				    </select>
					<input type="submit" name="submit" value="Approve" class="jun_button">
					</form>    
				</div>
				</td></tr>
				</table>
